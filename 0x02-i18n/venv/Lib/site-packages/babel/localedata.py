...
def load(name: os.PathLike[str] | str,
         merge_inherited: bool = True) -> dict[str, Any]:
...
class LocaleDataDict(abc.MutableMapping):
    ...
    def __init__(self,
                 data: MutableMapping[str | int | None,
                                      Any],
                 base: Mapping[str | int | None,
                               Any] | None = None):
        self._data = data
        if base is None:
            base = data
