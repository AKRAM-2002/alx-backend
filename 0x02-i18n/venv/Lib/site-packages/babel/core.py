...
class Locale:
    ...
    @classmethod
    def default(cls, category: str | None = None,
                aliases: Mapping[str, str] = LOCALE_ALIASES) -> Locale:
    ...
    def get_display_name(self, locale: Locale | str |
                         None = None) -> str | None:
    ...
    def get_language_name(self, locale: Locale | str |
                          None = None) -> str | None:
    ...
    def get_territory_name(self, locale: Locale | str |
                           None = None) -> str | None:
    ...
    def get_script_name(self, locale: Locale | str |
                        None = None) -> str | None:
...
def default_locale(category: str | None = None,
                   aliases: Mapping[str,
                                    str] = LOCALE_ALIASES) -> str | None:
...
def negotiate_locale(preferred: Iterable[str],
                     available: Iterable[str],
                     sep: str = '_',
                     aliases: Mapping[str,
                     str] = LOCALE_ALIASES) -> str | None:
...
def parse_locale(identifier: str,
                 sep: str = '_',
                 ) -> tuple[str,
                            str | None,
                            str | None,
