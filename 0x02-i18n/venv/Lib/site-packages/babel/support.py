...
class Format:
    ...
    def decimal(self, number: float | decimal.Decimal |
                str, format: str | None = None) -> str:
    ...
    def percent(self, number: float | decimal.Decimal |
                str, format: str | None = None) -> str:
...
class NullTranslations(gettext.NullTranslations):
    ...
    def __init__(self, fp: gettext._TranslationsReader | None = None) -> None:
        ...
        # some *gettext methods (including '.gettext()') rely on the
        # attributes.
        self._catalog: dict[tuple[str, Any] | str, str] = {}
        self.plural: Callable[[float | decimal.Decimal],
                              int] = lambda n: int(n != 1)
    ...
    def lnpgettext(
        ...
        try:
            ...
            if self._fallback:
                return self._fallback.lnpgettext(
    ...
    def unpgettext(
        ...
        try:
            ...
            if self._fallback:
                return self._fallback.unpgettext(
                    context, singular, plural, num)
    ...
    def ldpgettext(self, domain: str, context: str,
                   message: str) -> str | bytes | object:
...
class Translations(NullTranslations, gettext.GNUTranslations):
    ...
    def __init__(self, fp: gettext._TranslationsReader |
                 None = None, domain: str | None = None):
