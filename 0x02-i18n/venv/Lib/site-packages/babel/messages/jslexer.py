...
_rules: list[tuple[str | None, re.Pattern[str]]] = [
    ...
    ('jsx_tag', re.compile(r'(?:</?[^>\s]+|/>)',
     re.I)),  # May be mangled in `get_rules`
...
def get_rules(jsx: bool, dotted: bool,
              template_string: bool) -> list[tuple[str | None, re.Pattern[str]]]:
    """
